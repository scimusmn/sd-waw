...
if (Components.find({ colorPalate: colorPalate }).count() === 0) {
  ...
  Pages.insert({
    ...
    order: 4,
    bodyCopy: '<p>The abandoned gold mine from which this canyon gets its name has long been closed off. But you will see plenty of Teddy-bear Cholla. Don’t be fooled by its name: this snuggly looking cactus is anything but cuddly!</p><p>Join the Canyoneers for guided hikes in southern California.</p>',
    espBodyCopy: '<p>La mina de oro abandonada del este cañon toma su nombre fue cerrada hace tiempo. Sin embargo, podrás ver muchos cactus oso de peluche. No te dejas engañar por su nombre: ieste cactus al cual dan ganas de abrazar no es para nada afectuoso, así que no lo hagas!</p><p>Únete a los Canyoneers para caminatas guiadas en el sur de California.</p>',
    websiteCall: 'For more information, visit:',
    websiteCallEsp: 'Para más información, visita:',
    websiteURL: 'sdnat.org/canyoneers',
