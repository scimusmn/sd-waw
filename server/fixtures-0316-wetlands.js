...
if (Components.find( { 'colorPalate': colorPalate } ).count() === 0) {
    ...
    Pages.insert({
        ...
        order: 2,
        bodyCopy: 'Southe<span class=\"space-out\">r</span>n Califo<span class=\"space-out\">r</span>nia has 28 wetlands that line the coast from Santa Barbara south to Mexico.',
        bodyCopyLayout: 'horizontal',
        espBodyCopy: 'El sur de Califo<span class=\"space-out\">r</span>nia tiene veintiocho marismas que bordean la costa desde Santa Bárbara hasta México en el sur.',
    ...
    Pages.insert({
        ...
        order: 3,
        bodyCopy: '<p>More than 90% of southe<span class=\"space-out\">r</span>n Califo<span class=\"space-out\">r</span>nia’s wetland habitat has disappeared due to continuing real estate development.</p><p>Compare these maps to see how much habitat has been lost.</p>',
        espBodyCopy: '<p>Más del noventa por ciento del hábitat de las marismas del sur de Califo<span class=\"space-out\">r</span>nia ha desaparecido debido al constante desa<span class=\"space-out\">rr</span>ollo urbano.</p><p>Compare estos mapas para ver cuánto hábitat se ha perdido.</p>',
    ...
    Pages.insert({
        ...
        order: 4,
        bodyCopy: '<p>Each year more than a billion birds use the Pacific <br>Flyway—a series of wetlands along North America’s west coast—on the migratory jou<span class=\"space-out\">r</span>ney between their seasonal northe<span class=\"space-out\">r</span>n and southe<span class=\"space-out\">r</span>n homes.</p><p>Meet some of the birds that travel the Pacific Flyway.</p>',
        ...
        markers: [
            {
                ...
                arrowLeft: '1130',
                arrowTop: '460',
                bodyCopy: 'After nesting in Alaska, Black-bellied Plovers migrate south on the Pacific Flyway to winter in southe<span class=\"space-out\">r</span>n Califo<span class=\"space-out\">r</span>nia.',
                espBodyCopy: 'Después de anidar en Alaska, el chorlo gris migra hacia el sur por la ruta migratoria del Pacífico para pasar el invie<span class=\"space-out\">r</span>no en el sur de Califo<span class=\"space-out\">r</span>nia.',
                markerImage: 'wet-plover.jpg'
            },

            {
                order: 2,
                label: 'Weste<span class=\"space-out\">r</span>n Sandpiper',
                ...
                arrowLeft: '1036',
                arrowTop: '369',
                bodyCopy: 'Weste<span class=\"space-out\">r</span>n Sandpipers endure long jou<span class=\"space-out\">r</span>neys between their northe<span class=\"space-out\">r</span>n breeding grounds in Alaska and winter homes in the lower 48 states, Mexico, Central and South America.',
...

            {
                ...
                arrowLeft: '1070',
                arrowTop: '265',
                bodyCopy: 'Immediately after nesting, Marbled Godwits migrate to the west coast to feed in our wetlands—escaping the cold winter in the northe<span class=\"space-out\">r</span>n Great Plains months before it a<span class=\"space-out\">r</span>rives.',
                espBodyCopy: 'Inmediatamente después de anidar, el picopando canelo migra a la costa oeste para buscar alimento en nuestras marismas; de esta manera se escapa meses antes de la llegada del frío invie<span class=\"space-out\">r</span>no en las Grandes Llanuras del norte.',
    ...
    Pages.insert({
        ...
        order: 1,
        bodyCopy: 'Visit Bolsa Chica Ecological Reserve to experience the largest saltwater wetland in southe<span class=\"space-out\">r</span>n Califo<span class=\"space-out\">r</span>nia.',
        espBodyCopy: 'Visita la Reserva Ecológica Bolsa Chica para conocer de cerca la marisma de agua salada más grande del sur de Califo<span class=\"space-out\">r</span>nia.',
    ...
    Pages.insert({
        ...
        order: 2,
        bodyCopy: '<p>Glimpse some of the more than 700 plant and animal species that inhabit this county preserve. Bring your binoculars!</p><p>Join the Canyoneers for guided hikes in southe<span class=\"space-out\">r</span>n Califo<span class=\"space-out\">r</span>nia.</p>',
        espBodyCopy: '<p>Ven a ver algunas de las más de setecientas especies de plantas y animales que habitan esta reserva del condado. ¡Trae tus largavistas!</p><p>Únete a los Canyoneers para caminatas guiadas en el sur de Califo<span class=\"space-out\">r</span>nia.</p>',
        websiteCall: 'For more information, visit:',
        websiteCallEsp: 'Para más información, visita:',
    ...
    Pages.insert({
        ...
        order: 3,
        bodyCopy: '<p>Hike the weste<span class=\"space-out\">r</span>n-most section of the Coast to Crest Trail, which will extend 55 miles from the ocean at Del Mar to Volcan Mountain just north of Julian.</p><p>Join the Canyoneers for guided hikes in southe<span class=\"space-out\">r</span>n Califo<span class=\"space-out\">r</span>nia.</p>',
        espBodyCopy: '<p>Camina por la parte más occidental del sendero Coast to Crest, el cual se extiende cincuenta y cinco millas desde el océano en Del Mar hasta la montaña Volcan justo al norte de Julian.</p><p>Únete a los Canyoneers para caminatas guiadas en el sur de Califo<span class=\"space-out\">r</span>nia.</p>',
        websiteCall: 'For more information, visit:',
        websiteCallEsp: 'Para más información, visita:',
        websiteURL: 'sdnat.org/canyoneers',
    ...
    Pages.insert({
        ...
        order: 4,
        bodyCopy: '<p>Enjoy the ocean breeze and hike alongside one of the few remaining coastal wetlands in southe<span class=\"space-out\">r</span>n Califo<span class=\"space-out\">r</span>nia.</p><p>Join the Canyoneers for guided hikes in southe<span class=\"space-out\">r</span>n Califo<span class=\"space-out\">r</span>nia.</p>',
        espBodyCopy: '<p>Disfruta de la brisa marina y camina a lo largo de uno de los pocos estuarios costeros que quedan en el sur de Califo<span class=\"space-out\">r</span>nia.</p><p>Únete a los Canyoneers para caminatas guiadas en el sur de Califo<span class=\"space-out\">r</span>nia.</p>',
        websiteCall: 'For more information, visit:',
        websiteCallEsp: 'Para más información, visita:',
        websiteURL: 'sdnat.org/canyoneers',
    ...
    Pages.insert({
        ...
        order: 2,
        bodyCopy: '"The Marsh Wren is well named, since it’s rarely seen outside a marsh. Each male builds multiple nests—woven around tules or cattails—possibly to help advertise his te<span class=\"space-out\">r</span>ritory. The female selects one nest, or builds her own, before laying her eggs. The subspecies clarkae appears only in coastal southe<span class=\"space-out\">r</span>n Califo<span class=\"space-out\">r</span>nia."',
        espBodyCopy: '"El chivirín pantanero está aptamente nombrado, ya que pocas veces se lo ve fuera de un pantano. Cada macho construye múltiples nidos, tejidos alrededor de juncos o totoras, posiblemente para ayudarle a demarcar su te<span class=\"space-out\">r</span>ritorio. La hembra elige un nido, o construye el suyo propio, antes de poner sus huevos.  La subespecie clarkae aparece únicamente en la costa del sur de Califo<span class=\"space-out\">r</span>nia".',
