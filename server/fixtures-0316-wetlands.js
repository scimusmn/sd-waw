...
if (Components.find( { 'colorPalate': colorPalate } ).count() === 0) {
    ...
    Pages.insert({
        ...
        markers: [
            ...
            {order: 3, label: 'Mission Bay Marsh', dotLeft: '927', dotTop: '479', arrowLeft: '1027', arrowTop: '491'},
            {order: 4, label: 'Los Penasquitos Lagoon', dotLeft: '881', dotTop: '456', arrowLeft: '1023', arrowTop: '452'},
            {order: 5, label: 'San Dieguito Lagoon', dotLeft: '835', dotTop: '433', arrowLeft: '1023', arrowTop: '442'},
            {order: 6, label: 'San Elijo Lagoon', dotLeft: '789', dotTop: '410', arrowLeft: '1020', arrowTop: '430'},
            {order: 7, label: 'Batiquitos Lagoon', dotLeft: '976', dotTop: '433', arrowLeft: '1012', arrowTop: '408'},
            {order: 8, label: 'Agua Hedionda', dotLeft: '920', dotTop: '412', arrowLeft: '1012', arrowTop: '390'},
            {order: 9, label: 'Buena Vista Lagoon', dotLeft: '864', dotTop: '391', arrowLeft: '998', arrowTop: '375'},
            {order: 10, label: 'San Luis Rey River Marsh', dotLeft: '799', dotTop: '370', arrowLeft: '984', arrowTop: '360'},
            {order: 11, label: 'Santa Margarita River', dotLeft: '755', dotTop: '349', arrowLeft: '976', arrowTop: '355'},
