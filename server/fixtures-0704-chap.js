...
if (Components.find( { 'colorPalate': colorPalate } ).count() === 0) {
    ...
    Pages.insert({
        ...
        order: 1,
        bodyCopy: '<p>Chapa<span class=\"space-out\">r</span>ral grows almost everywhere in southern California.</p><p>Early Spanish visitors to the region called this extensive plant habitat chapa<span class=\"space-out\">r</span>ro ("short one") because of its abundance of shrubs and short oaks.</p>',
        espBodyCopy: '<p>El chapa<span class=\"space-out\">r</span>ral crece casi por todas partes en el sur de California.</p><p>Los primeros españoles en visitar la región llamaron a este extenso hábitat de plantas chapa<span class=\"space-out\">r</span>ro ("bajo en estatura") debido a sus abundantes arbustos y robles bajos.</p>',
    ...
    Pages.insert({
        ...
        espBodyCopy: '<p> El chapa<span class=\"space-out\">r</span>ral conoce muy bien los largos y secos veranos y los inviernos templados y lluviosos. Las varias plantas que componen este hábitat deben tolerar largos períodos de sequía e incendios naturales.  </p><p> Las plantas del chapa<span class=\"space-out\">r</span>ral típicamente tienen raíces y tallos leñosos y hojas gruesas y co<span class=\"space-out\">r</span>reosas. Aquí el chamizo es una de las especies de plantas más comunes.  </p>',
        bodyImages: [ {
    ...
    Pages.insert({
        ...
        bodyCopy: '<p> Coastal California is one of only five places on Earth known as a Medite<span class=\"space-out\">r</span>ranean climate zone.</p><p> The mild, wet winters and long, dry summers typical of this climate zone are ideal for the xerophilous (pronounced ze-RA-fe-les, meaning “dry-loving”) chapa<span class=\"space-out\">r</span>ral plants.</p>',
        espBodyCopy: '<p> La costa de California es sólo uno de cinco lugares en la Tie<span class=\"space-out\">r</span>ra que se conocen como zonas climáticas medite<span class=\"space-out\">r</span>ráneas.</p><p>Los templados y lluviosos inviernos y los veranos largos y secos típicos de esta zona climática son ideales para las plantas de chapa<span class=\"space-out\">r</span>ral xerófilas (pronunciado ce-RO-fi-las, lo que significa que les gusta la sequedad).  </p>',
    ...
    Pages.insert({
        ...
        order: 4,
        //bodyCopyLayout: 'horizontal',
        bodyCopy: '<p> Fire is part of the natural life cycle in the chapa<span class=\"space-out\">r</span>ral habitat. Planning for fires is a necessary part of life in southern California.  </p><p>Move the timeline to see the places in southern California where fires have burned during the past century. </p>',
        espBodyCopy: '<p> Los incendios son una parte del ciclo natural de vida del hábitat del chapa<span class=\"space-out\">r</span>ral.  La planificación para casos de incendio es un aspecto necesario de la vida en el sur de California.  </p><p>Desplaza el cronograma para ver en qué lugares del sur de  California han habido incendios en el último siglo. </p>',
    ...
    Pages.insert({
        ...
        order: 1,
        bodyCopy: 'Visit Chino Hills State Park for a day hike or an overnight stay amid chapa<span class=\"space-out\">r</span>ral and coastal sage scrub habitats.',
    ...
    Pages.insert({
        ...
        order: 2,
        bodyCopy: '<p>Climb a steep trail to the top of a ridge, where you’ll take in sweeping views of hills covered in chapa<span class=\"space-out\">r</span>ral and coastal sage scrub. </p><p>Join the Canyoneers for this and other guided hikes in southern California.</p>',
        espBodyCopy: '<p>Escala por un sendero empinado hasta la cima de una cresta donde podrás apreciar vistas panorámicas de colinas cubiertas de chapa<span class=\"space-out\">r</span>ral y mato<span class=\"space-out\">r</span>ral costero de salvia.</p><p>Únete a los Canyoneers para disfrutar de ésta y otras caminatas guiadas en el sur de California.</p>',
        websiteCall: 'For more information, visit:',
        websiteCallEsp: 'Para más información, visita:',
    ...
    Pages.insert({
        ...
        order: 4,
        bodyCopy: '<p> Enjoy a challenging but rewarding hike through the chapa<span class=\"space-out\">r</span>ral and on up to the peak of Iron Mountain.</p><p>Join the Canyoneers for this and other guided hikes in southern California.</p>',
        espBodyCopy: '<p>Disfruta de una caminata ardua pero gratificante por el chapa<span class=\"space-out\">r</span>ral y hasta la cima de Iron Mountain. </p><p>Únete a los Canyoneers para disfrutar de ésta y otras caminatas guiadas en el sur de California.</p>',
        websiteCall: 'For more information, visit:',
        websiteCallEsp: 'Para más información, visita:',
        websiteURL: 'sdnat.org/canyoneers',
